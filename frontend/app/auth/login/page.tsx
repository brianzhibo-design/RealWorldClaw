...
export default function LoginPage() {
  ...
  const triggerConfetti = () => {
    confetti({
      ...
      spread: 70,
      origin: { y: 0.6 },
      colors: ["#10b981", "#22d3ee", "#38bdf8", "#a78bfa"],
      ticks: 120,
      gravity: 1.1,
    });
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessUsername(res.user.username);
      setSuccess(true);
      triggerConfetti();
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl grid md:grid-cols-5 gap-6">
        ...
        >
          <div className="rounded-xl border border-slate-800 bg-slate-900/80 p-8 min-h-[620px] flex items-center justify-center">
              ...
              {!success ? (
                ...
                >
                  <motion.div
                    ...
                    className="w-20 h-20 rounded-full border-2 border-[#10b981]/60 bg-[#10b981]/10 flex items-center justify-center"
                  >
                  ...
                  <p className="mt-5 text-lg font-semibold text-white">Welcome back, {successUsername}!</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
        ...
        >
          <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-6 h-full flex flex-col">
            <div className="mb-4">
              ...
              <p className="text-xs text-slate-400">Authenticate via API Key</p>
            </div>
