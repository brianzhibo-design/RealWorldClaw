...
export default function Home() {
  ...
  return (
    <div className="relative w-full h-screen bg-slate-950 overflow-hidden">
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-6 py-3 bg-slate-950/80 backdrop-blur-sm border-b border-slate-800/50">
        <div className="flex items-center gap-3">
          <svg viewBox="0 0 130 130" className="w-7 h-7">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <a href="/auth/login" className="text-slate-300 hover:text-white transition-colors">
            Sign In
          </a>
          <a
            href="/makers/register"
            className="px-3 py-1.5 bg-sky-600 hover:bg-sky-500 text-white rounded-md transition-colors text-sm font-medium"
          >
