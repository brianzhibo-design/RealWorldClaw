...
def init_db():
    ...
    with get_db() as db:
        ...
        alter_table_statements = [
            ...
            "ALTER TABLE users ADD COLUMN IF NOT EXISTS consent TEXT NOT NULL DEFAULT '{}'",
            "ALTER TABLE users ADD COLUMN IF NOT EXISTS deleted_at VARCHAR(255)",
            "ALTER TABLE users ADD COLUMN IF NOT EXISTS anonymized INTEGER NOT NULL DEFAULT 0",
